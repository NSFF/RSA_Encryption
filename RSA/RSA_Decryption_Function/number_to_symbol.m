...
function number_to_symbol(var_string_number_1)
%%
global n
global m
global e_unchanged
...
m(var_string_index)= list_powers_string(list_wich_powers(local_var_size_LWP));
m_with_modulo_powers(n,list_powers_string)
end